...
from homeassistant.components.media_player import (
    ...
    SUPPORT_VOLUME_UP, SUPPORT_VOLUME_DOWN #XXXBoth new
    SUPPORT_PLAY)
...
SUPPORT_PIONEER = SUPPORT_PAUSE | SUPPORT_VOLUME_UP | SUPPORT_VOLUME_MUTE | \
                  SUPPORT_TURN_ON | SUPPORT_TURN_OFF | SUPPORT_VOLUME_DOWN | \
                  SUPPORT_SELECT_SOURCE | SUPPORT_PLAY
